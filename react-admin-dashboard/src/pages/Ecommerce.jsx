  ...
  return (
    <div className='mt-12'>
      <div className='flex flex-col md:flex-row flex-wrap justify-center'>
        ...
        w-full md:w-85 p-8 pt-9 m-3 bg-hero-pattern bg-no-repeat bg-cover bg-center'>
          <div className='flex justify-between items-center'>
            <div>
              <p className='font-bold text-gray-400'>Earnings</p>
              <p className='text-2xl'>$53,242.39</p>
            </div>
          </div>
          <div className='mt-6'>
            <Button
        ...
        rounded-2xl md:w-780'>
          ...
          <div className='mt-10 flex gap-10 flex-wrap justify-center'>
            <div className='border-r-1 border-color m-4 pr-10'>
              <div>
                <p>
                  <span className='text-3xl font-semibold'>$53,242.39</span>
              ...
              <div className='mt-8'>
                <p>
                  <span className='text-3xl font-semibold'>$23,242.39</span>
                </p>
